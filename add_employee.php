<?php
  ...
  if(isset($_POST['submit'])!="")
  {
   ...
   $sql = mysqli_query($conn,"INSERT into employee(lname, fname, gender, emp_type, division, deduction, overtime, bonus) VALUES ('$lname','$fname','$gender','$type','$division', 1, 1,1)");
