                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      ...
                      <option value="<?php echo $med_alw; ?>">Medical Allowances</option>
                      <option value="<?php echo $ed_alw; ?>">Education Allowances</option>
                      <option value="<?php echo $med_alw; ?>">Meal Coupon</option>
                      <option value="<?php echo $lta; ?>">LTA</option>
                      <option value="<?php echo $hra; ?>">HRA</option>
                    </select>
                  </div>
                  </div>
                  <div class="form-group">
