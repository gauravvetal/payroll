...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li><a href="home_deductions.php">Deductions</a></li>
      ...
      <!-- Site footer -->
      <footer class="footer">
        <p align="center">&copy; All Rights Reserved 2023</p>
        <p align="center">Copyright by <a target="_blank" href="https://indiraicem.ac.in/" data-show-count="true">Indira College Of Engineering and Management</a></p>
        <p align="center">Developed By: Sandeep Verma <br>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Gaurav Vetal <br>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Kalyani Kale</p>
      </footer>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div align="center">
                <a href="" target="_blank" title="My Instructor in WTL"><big><b>Prof. Deepali Dhadwad</b></big></a>
              </div>
            </div>
          </div>
        </div>
